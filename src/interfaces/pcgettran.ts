...
export function convertObjectToPCRcvTrn(dataIn: PCRcvTrn): string {
  ...
  dataOut += dataIn?.data?.createdByUserId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += dataIn?.data?.createdByUserName?.substring(0, 50)?.padEnd(50) ?? " ".substring(0, 50).padEnd(50);
  dataOut += dataIn?.data?.modifiedByUserId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.data?.externalSystemId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.data?.paymentDueDateDiff?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.data?.isRegisteredMerchant?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  ...
  dataOut += dataIn?.data?.currencyExchangeRate?.toFixed(5)?.substring(0, 17)?.padEnd(17) ?? "0".substring(0, 17).padEnd(17);
  dataOut += dataIn?.data?.vendorTotalAmount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ?? "0".substring(0, 17).padEnd(17);
  dataOut += dataIn?.data?.approvedByUserId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
