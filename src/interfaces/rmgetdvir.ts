...
export function convertObjectToRtnDVIRRes(dataIn: RtnDVIRRes): string {
    ...
    dataOut += dataIn.repsonse.code.toFixed().substring(0, 6).padEnd(6);
    dataOut += dataIn.repsonse.type.substring(0, 10).padEnd(10);
    dataOut += dataIn.repsonse.message.substring(0, 200).padEnd(200);
