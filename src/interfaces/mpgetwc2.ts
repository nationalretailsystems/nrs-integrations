...
export function convertObjectToResWo2Chg(dataIn: ResWo2Chg): string {
    ...
    dataOut +=
        dataIn?.dateCreated !== (undefined || null)
            ? toIbmiTimestamp(dataIn?.dateCreated, 26)
            : '0001-01-01-00.00.00.000'.substring(0, 26).padEnd(26);
    dataOut +=
        dataIn?.dateCompleted !== (undefined || null)
            ? toIbmiTimestamp(dataIn?.dateCompleted, 26)
            : '0001-01-01-00.00.00.000'.substring(0, 26).padEnd(26);
