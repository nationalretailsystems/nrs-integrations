...
export function convertObjectToPCRcvRpt(dataIn: PCRcvRpt): string {
    ...
    for (let i: number = 0; i < 40; ++i) {
        ...
        dataOut +=
            dataIn?.recordset[i]?.transaction_id?.toFixed()?.substring(0, 11)?.padEnd(11) ??
        ...
        dataOut +=
            dataIn?.recordset[i]?.transaction_type?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        ...
        dataOut +=
            dataIn?.recordset[i]?.debitAmount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ??
            '0'.substring(0, 17).padEnd(17);
        dataOut +=
            dataIn?.recordset[i]?.creditAmount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ??
            '0'.substring(0, 17).padEnd(17);
        dataOut +=
            dataIn?.recordset[i]?.payorBatch?.toFixed()?.substring(0, 11)?.padEnd(11) ??
            '0'.substring(0, 11).padEnd(11);
        dataOut += dataIn?.recordset[i]?.payorDate?.substring(0, 24)?.padEnd(24) ?? ' '.substring(0, 24).padEnd(24);
        dataOut +=
            dataIn?.recordset[i]?.payeeBatch?.toFixed()?.substring(0, 11)?.padEnd(11) ??
            '0'.substring(0, 11).padEnd(11);
        ...
        dataOut +=
            dataIn?.recordset[i]?.customer_reference_number?.substring(0, 25)?.padEnd(25) ??
            ' '.substring(0, 25).padEnd(25);
        dataOut +=
            dataIn?.recordset[i]?.shipper_reference_number?.substring(0, 25)?.padEnd(25) ??
            ' '.substring(0, 25).padEnd(25);
        ...
        dataOut +=
            dataIn?.recordset[i]?.approvedByUserName?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut += dataIn?.recordset[i]?.currency?.substring(0, 3)?.padEnd(3) ?? ' '.substring(0, 3).padEnd(3);
        dataOut +=
            dataIn?.recordset[i]?.payerId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? '0'.substring(0, 11).padEnd(11);
        dataOut +=
            dataIn?.recordset[i]?.vendorId?.toFixed()?.substring(0, 11)?.padEnd(11) ?? '0'.substring(0, 11).padEnd(11);
        dataOut +=
            dataIn?.recordset[i]?.payerReferenceNumber?.substring(0, 10)?.padEnd(10) ?? ' '.substring(0, 10).padEnd(10);
        ...
        dataOut +=
            dataIn?.recordset[i]?.payerInternalNumber?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut +=
            dataIn?.recordset[i]?.payerFileNumber?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut +=
            dataIn?.recordset[i]?.payerVoucherNumber?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut +=
            dataIn?.recordset[i]?.payerProductNumber?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut +=
            dataIn?.recordset[i]?.payerInvoiceNumber?.substring(0, 25)?.padEnd(25) ?? ' '.substring(0, 25).padEnd(25);
        dataOut += dataIn?.recordset[i]?.bolLink?.substring(0, 50)?.padEnd(50) ?? ' '.substring(0, 50).padEnd(50);
    }
    dataOut +=
        dataIn?.overall?.count?.toFixed()?.substring(0, 11)?.padEnd(11) ??
        missingInput(`dataIn.overall.count`, 'integer', dataIn?.overall?.count);
    dataOut +=
        dataIn?.overall?.debitamount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ??
        missingInput(`dataIn.overall.debitamount`, 'packed', dataIn?.overall?.debitamount);
    dataOut +=
        dataIn?.overall?.creditamount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ??
        missingInput(`dataIn.overall.creditamount`, 'packed', dataIn?.overall?.creditamount);
    dataOut +=
        dataIn?.payor?.batch?.toFixed()?.substring(0, 11)?.padEnd(11) ??
        missingInput(`dataIn.payor.batch`, 'integer', dataIn?.payor?.batch);
    dataOut +=
        dataIn?.payor?.amount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ??
        missingInput(`dataIn.payor.amount`, 'packed', dataIn?.payor?.amount);
