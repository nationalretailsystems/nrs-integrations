...
export function convertObjectToPCRcvRpt(dataIn: PCRcvRpt): string {
    ...
    dataOut += dataIn?.overall?.count?.toFixed()?.substring(0, 11)?.padEnd(11) ?? '0'.substring(0, 11).padEnd(11);
    dataOut +=
        dataIn?.overall?.debitamount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ?? '0'.substring(0, 17).padEnd(17);
    dataOut +=
        dataIn?.overall?.creditamount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ?? '0'.substring(0, 17).padEnd(17);
    dataOut += dataIn?.payor?.batch?.toFixed()?.substring(0, 11)?.padEnd(11) ?? '0'.substring(0, 11).padEnd(11);
    dataOut += dataIn?.payor?.amount?.toFixed(5)?.substring(0, 17)?.padEnd(17) ?? '0'.substring(0, 17).padEnd(17);
