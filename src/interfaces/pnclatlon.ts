...
export function convertObjectToLLRes(dataIn: LLRes): string {
    ...
    dataOut += dataIn.time.substring(0, 29).padEnd(29);
    ...
    dataOut += dataIn.data.asset.checked_in.substring(0, 29).padEnd(29);
    dataOut += dataIn.data.asset.checked_out.substring(0, 29).padEnd(29);
    dataOut += dataIn.data.asset.updated_on.substring(0, 29).padEnd(29);
    ...
    dataOut += dataIn.data.asset.asset_visit_id.toFixed().substring(0, 11).padEnd(11);
    dataOut += dataIn.data.asset.is_dock ? '1' : '0';
    dataOut += dataIn.data.asset.Latitude.substring(0, 25).padEnd(25);
