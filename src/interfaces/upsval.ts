...
export function convertObjectToRespFmt(dataIn: RespFmt): string {
    ...
    dataOut +=
        dataIn?.XAVResponse?.Response?.ResponseStatus?.Code?.substring(0, 10)?.padEnd(10) ??
        ''.substring(0, 10).padEnd(10);
    dataOut +=
        dataIn?.XAVResponse?.Response?.ResponseStatus?.Description?.substring(0, 150)?.padEnd(150) ??
        ''.substring(0, 150).padEnd(150);
    dataOut +=
        dataIn?.XAVResponse?.AmbiguousAddressIndicator?.substring(0, 1)?.padEnd(1) ?? ''.substring(0, 1).padEnd(1);
    dataOut += dataIn?.XAVResponse?.ValidAddressIndicator?.substring(0, 1)?.padEnd(1) ?? ''.substring(0, 1).padEnd(1);
    for (let j: number = 0; j < 5; ++j) {
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressClassification?.Code?.substring(0, 10)?.padEnd(10) ??
            ''.substring(0, 10).padEnd(10);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressClassification?.Description?.substring(0, 150)?.padEnd(150) ??
            ''.substring(0, 150).padEnd(150);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.ConsigneeName?.substring(0, 50)?.padEnd(50) ??
            ''.substring(0, 50).padEnd(50);
        for (let m: number = 0; m < 2; ++m) {
            dataOut +=
                dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.AddressLine[m]?.substring(0, 100)?.padEnd(100) ??
                ''.substring(0, 100).padEnd(100);
        }
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.PoliticalDivision2?.substring(0, 30)?.padEnd(30) ??
            ''.substring(0, 30).padEnd(30);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.PoliticalDivision1?.substring(0, 30)?.padEnd(30) ??
            ''.substring(0, 30).padEnd(30);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.PostcodePrimaryLow?.substring(0, 10)?.padEnd(10) ??
            ''.substring(0, 10).padEnd(10);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.PostCodeExtendedLow?.substring(0, 10)?.padEnd(10) ??
            ''.substring(0, 10).padEnd(10);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.Urbanization?.substring(0, 30)?.padEnd(30) ??
            ''.substring(0, 30).padEnd(30);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.Region?.substring(0, 100)?.padEnd(100) ??
            ''.substring(0, 100).padEnd(100);
        dataOut +=
            dataIn?.XAVResponse?.Candidate[j]?.AddressKeyFormat?.CountryCode?.substring(0, 2)?.padEnd(2) ??
