...
export function convertObjectToTrlRtnDta(dataIn: TrlRtnDta): string {
  ...
  dataOut += dataIn?.skybitz?.gls?.binary?.inputstate?.substring(0, 10)?.padEnd(10) ?? " ".substring(0, 10).padEnd(10);
  dataOut += dataIn?.skybitz?.gls?.extpwr?.substring(0, 1)?.padEnd(1) ?? " ".substring(0, 1).padEnd(1);
  for (let k: number = 0; k < 10; ++k) {
  dataOut += dataIn?.skybitz?.gls?.serial[k]?.serialtype?.substring(0, 2)?.padEnd(2) ?? " ".substring(0, 2).padEnd(2);
  dataOut += dataIn?.skybitz?.gls?.serial[k]?.serialid?.substring(0, 10)?.padEnd(10) ?? " ".substring(0, 10).padEnd(10);
  dataOut += dataIn?.skybitz?.gls?.serial[k]?.serialname?.substring(0, 20)?.padEnd(20) ?? " ".substring(0, 20).padEnd(20);
  dataOut += dataIn?.skybitz?.gls?.serial[k]?.serialdata?.substring(0, 20)?.padEnd(20) ?? " ".substring(0, 20).padEnd(20);
  }
  ...
  dataOut += dataIn?.skybitz?.gls?.landmark?.distance?.substring(0, 15)?.padEnd(15) ?? " ".substring(0, 15).padEnd(15);
  dataOut += dataIn?.skybitz?.gls?.landmark?.direction?.substring(0, 3)?.padEnd(3) ?? " ".substring(0, 3).padEnd(3);
  dataOut += dataIn?.skybitz?.gls?.landmark?.geotypename?.substring(0, 15)?.padEnd(15) ?? " ".substring(0, 15).padEnd(15);
  dataOut += dataIn?.skybitz?.gls?.landmark?.geoshape?.substring(0, 15)?.padEnd(15) ?? " ".substring(0, 15).padEnd(15);
  ...
  dataOut += dataIn?.skybitz?.gls?.skyfence?.skyfencestatus?.substring(0, 10)?.padEnd(10) ?? " ".substring(0, 10).padEnd(10);
  dataOut += dataIn?.skybitz?.gls?.idle?.idlestatus?.substring(0, 10)?.padEnd(10) ?? " ".substring(0, 10).padEnd(10);
  dataOut += dataIn?.skybitz?.gls?.idle?.idleduration?.substring(0, 10)?.padEnd(10) ?? " ".substring(0, 10).padEnd(10);
