...
export function convertObjectToPunchRes(dataIn: PunchRes): string {
  ...
  dataOut += dataIn?.punches[i]?.employee?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.punches[i]?.timeZone?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.punches[i]?.editByType?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.editByType?.qualifier?.substring(0, 3)?.padEnd(3) ?? "".substring(0, 3).padEnd(3);
  dataOut += dataIn?.punches[i]?.editByType?.name?.substring(0, 25)?.padEnd(25) ?? "".substring(0, 25).padEnd(25);
  dataOut += dataIn?.punches[i]?.dataSource?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  ...
  dataOut += dataIn?.punches[i]?.typeOverride?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.typeOverride?.qualifier?.substring(0, 15)?.padEnd(15) ?? "".substring(0, 15).padEnd(15);
  dataOut += dataIn?.punches[i]?.typeOverride?.typeOverrideId?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  ...
  dataOut += dataIn?.punches[i]?.exceptions[k]?.employee?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.employee?.qualifier?.substring(0, 6)?.padEnd(6) ?? "".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.employee?.name?.substring(0, 6)?.padEnd(6) ?? "".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.startDateTime?.substring(0, 19)?.padEnd(19) ?? "".substring(0, 19).padEnd(19);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.endDateTime?.substring(0, 19)?.padEnd(19) ?? "".substring(0, 19).padEnd(19);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.applyDate?.substring(0, 10)?.padEnd(10) ?? "".substring(0, 10).padEnd(10);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.endTimeZone?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.exceptionType?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.exceptionType?.name?.substring(0, 8)?.padEnd(8) ?? "".substring(0, 8).padEnd(8);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.exceptionType?.description?.substring(0, 12)?.padEnd(12) ?? "".substring(0, 12).padEnd(12);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.exceptionType?.displayName?.substring(0, 8)?.padEnd(8) ?? "".substring(0, 8).padEnd(8);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.exceptionType?.category?.substring(0, 19)?.padEnd(19) ?? "".substring(0, 19).padEnd(19);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.orgJob?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.overLimitInHours?.toFixed(2)?.substring(0, 7)?.padEnd(7) ?? "0".substring(0, 7).padEnd(7);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.startTimeZone?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.violationInHours?.toFixed(2)?.substring(0, 7)?.padEnd(7) ?? "0".substring(0, 7).padEnd(7);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.workRule?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.workRule?.qualifier?.substring(0, 5)?.padEnd(5) ?? "".substring(0, 5).padEnd(5);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.workRule?.name?.substring(0, 5)?.padEnd(5) ?? "".substring(0, 5).padEnd(5);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.punchEvent?.id?.toFixed()?.substring(0, 11)?.padEnd(11) ?? "0".substring(0, 11).padEnd(11);
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.isExcusedAbsence !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.isExcusedAbsence ? "1" : "0") : "0");
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.isUnExcusedAbsence !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.isUnExcusedAbsence ? "1" : "0") : "0");
  dataOut += dataIn?.punches[i]?.exceptions[k]?.missingTimeStatus?.id?.toFixed()?.substring(0, 6)?.padEnd(6) ?? "0".substring(0, 6).padEnd(6);
  dataOut += dataIn?.punches[i]?.exceptions[k]?.missingTimeStatus?.displayName?.substring(0, 14)?.padEnd(14) ?? "".substring(0, 14).padEnd(14);
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.transfer !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.transfer ? "1" : "0") : "0");
  dataOut += dataIn?.punches[i]?.exceptions[k]?.eventDate?.substring(0, 10)?.padEnd(10) ?? "".substring(0, 10).padEnd(10);
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.startException !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.startException ? "1" : "0") : "0");
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.endException !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.endException ? "1" : "0") : "1");
  dataOut += (dataIn?.punches[i]?.exceptions[k]?.reviewed !== undefined ? (dataIn?.punches[i]?.exceptions[k]?.reviewed ? "1" : "0") : "0");
  }
