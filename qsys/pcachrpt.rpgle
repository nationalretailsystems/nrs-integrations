      ...
      * Read fields from buffer into DS
       DataStruct.brnchclntid = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.startdate = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.enddate = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.clientid = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.rptactname = %subst(CharBuf:1:25);
       BufPtr += 25;
       DataStruct.type = %subst(CharBuf:1:25);
       BufPtr += 25;
       DataStruct.acctname = %subst(CharBuf:1:50);
       BufPtr += 50;
       for i = 1 to 2;
