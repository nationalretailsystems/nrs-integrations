      ...
      *****************************************************************
      ...
      // Assign Data To Variables
         ...
         MyReqData.data.asset.checked_in = 'bbbbbbbbbbbbbbbbbbbbbbbbb';
         MyReqData.data.asset.asset_type = 'ccccccccccccccccccccccccc';
         MyReqData.data.asset.rfid_tag = 'ddddddddddddddddddddddddd';
         MyReqData.data.asset.site_code = 'eeeeeeeeeeeeeeeeeeeeeeeee';
         MyReqData.data.asset.scac = 'ffff';
         MyReqData.data.asset.trailer = 'ggggggggggggggggggggggggg';
         MyReqData.data.asset.container_num = 'hhhhhhhhhhhhhhhhhhhhhhhhh';
         MyReqData.data.asset.movement_type = 'iiiiiiiiiiiiiiiiiiiiiiiii';
         MyReqData.data.asset.load_status = 'jjjjjjjjjjjjjjjjjjjjjjjjj';
         MyReqData.data.asset.customer_code = 'kkkkkkkkkkkkkkkkkkkkkkkkk';
         MyReqData.data.asset.fleet_code = 'lllllllllllllllllllllllll';
         MyReqData.data.asset.tractor_scac = 'mmmmmmmmmmmmmmmmmmmmmmmmm';
