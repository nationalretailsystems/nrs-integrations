      ...
      ************************************
      * Convert DrvReq to buffer
      ************************************
     PDrvReqToBuf      B                   Export

     DDrvReqToBuf      PI
     DDataStruct                           LikeDS(DrvReq)
     D                                     Const
     DBuffer                         10A
      ...
      * Write fields from DS to buffer
       %subst(CharBuf:1:10) = DataStruct.driver;
       BufPtr += 10;
      ...
      ************************************
      * Convert buffer to DrvRes
      ************************************
     PBufToDrvRes      B                   Export

     DBufToDrvRes      PI
     DBuffer                        285A
     DDataStruct                           LikeDS(DrvRes)
