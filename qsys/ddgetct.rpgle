      ...
      * Read fields from buffer into DS
       ...
       for i = 1 to 1;
       DataStruct.containers(i).contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       DataStruct.containers(i).pier_pass.contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       DataStruct.containers(i).cltrkfee.contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       BufPtr += 20;
       DataStruct.containers(i).impstat.observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       ...
       DataStruct.containers(i).impstat.id = %dec(%subst(CharBuf:1:3):1:0);
       BufPtr += 3;
       DataStruct.containers(i).impstat.cycle_id = %dec(%subst(CharBuf:1:3):1:0);
       BufPtr += 3;
       DataStruct.containers(i).impstat.lstobs = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).impstat.lstchk = %subst(CharBuf:1:20);
       BufPtr += 20;
       for j = 1 to 1;
       DataStruct.containers(i).impstats(j).terminal = %subst(CharBuf:1:7);
       BufPtr += 7;
       DataStruct.containers(i).impstats(j).contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       DataStruct.containers(i).impstats(j).lastfree = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.containers(i).impstats(j).masterbl = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       BufPtr += 16;
       DataStruct.containers(i).impstats(j).vessel = %subst(CharBuf:1:6);
       BufPtr += 6;
       DataStruct.containers(i).impstats(j).location = %subst(CharBuf:1:7);
       BufPtr += 7;
       DataStruct.containers(i).impstats(j).plocat = %subst(CharBuf:1:9);
       BufPtr += 9;
       ...
       BufPtr += 20;
       DataStruct.containers(i).impstats(j).observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       ...
       BufPtr += 16;
       DataStruct.containers(i).lateappt.direction = %subst(CharBuf:1:7);
       BufPtr += 7;
       DataStruct.containers(i).lateappt.windstrt = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).lateappt.window_end = %subst(CharBuf:1:20);
       BufPtr += 20;
       for j = 1 to 1;
       DataStruct.containers(i).lateappt.linkappts(j).termref = %subst(CharBuf:1:6);
       BufPtr += 6;
       DataStruct.containers(i).lateappt.linkappts(j).contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       endfor;
       ...
       BufPtr += 6;
       DataStruct.containers(i).lateappt.dsptrmref = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       BufPtr += 6;
       DataStruct.containers(i).lateappt.observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).lateappt.lstobs = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).lateappt.crtterm = %subst(CharBuf:1:20);
       BufPtr += 20;
       for j = 1 to 1;
       ...
       BufPtr += 10;
       DataStruct.containers(i).linimpstat.observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       ...
       BufPtr += 7;
       DataStruct.containers(i).ibgatetrn.contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       BufPtr += 1;
       DataStruct.containers(i).ibgatetrn.direction = %subst(CharBuf:1:7);
       BufPtr += 7;
       ...
       BufPtr += 6;
       DataStruct.containers(i).ibgatetrn.observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).obgatetrn.terminal = %subst(CharBuf:1:7);
       BufPtr += 7;
       DataStruct.containers(i).obgatetrn.contnumb = %subst(CharBuf:1:6);
       BufPtr += 6;
       ...
       BufPtr += 1;
       DataStruct.containers(i).obgatetrn.direction = %subst(CharBuf:1:7);
       BufPtr += 7;
       ...
       BufPtr += 20;
       DataStruct.containers(i).nextappt.observed = %subst(CharBuf:1:20);
       BufPtr += 20;
       ...
       BufPtr += 7;
       DataStruct.containers(i).watchtm = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).dischtm = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).impappttm = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).impoutgtm = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).mtappttm = %subst(CharBuf:1:20);
       BufPtr += 20;
       DataStruct.containers(i).mtigtime = %subst(CharBuf:1:20);
       BufPtr += 20;
