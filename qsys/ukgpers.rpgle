      ...
      * Read fields from buffer into DS
       ...
       BufPtr += 3;
       DataStruct.empextension.dataAccessExtensionGroups.assignDAGID = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
       DataStruct.empextension.dataAccessExtensionGroups.dataAccessGroup = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.empextension.dataAccessExtensionGroups.dataaccgrpid = %dec(%subst(CharBuf:1:4):2:0);
       BufPtr += 4;
       DataStruct.empextension.dataAccessExtensionGroups.dataaccgrprol = %subst(CharBuf:1:12);
       BufPtr += 12;
       DataStruct.empextension.dataAccessExtensionGroups.dataaccgrprid = %dec(%subst(CharBuf:1:4):2:0);
       BufPtr += 4;
       DataStruct.empextension.dataAccessExtensionGroups.defaultSwitch = %subst(CharBuf:1:1);
       BufPtr += 1;
       DataStruct.empextension.dataAccessExtensionGroups.effectiveDate = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.empextension.dataAccessExtensionGroups.expirationDate = %subst(CharBuf:1:10);
       BufPtr += 10;
       DataStruct.empextension.dataAccessExtensionGroups.personID = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
       ...
       BufPtr += 55;
       DataStruct.empextension.effprmjobact.primlabcatid = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
       ...
       BufPtr += 4;
       DataStruct.empextension.erlcondata.contactTypeId = %dec(%subst(CharBuf:1:3):1:0);
       BufPtr += 3;
       ...
       BufPtr += 1;
       DataStruct.empextension.jobAssigmentId = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
       DataStruct.empextension.jobAssignmentId = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
       ...
       BufPtr += 7;
       DataStruct.empextension.logonProfileId = %dec(%subst(CharBuf:1:3):1:0);
       BufPtr += 3;
       ...
       BufPtr += 15;
       DataStruct.empextension.superpersid = %dec(%subst(CharBuf:1:7):5:0);
       BufPtr += 7;
       ...
       BufPtr += 7;
       DataStruct.empextension.userAccountId = %dec(%subst(CharBuf:1:6):4:0);
       BufPtr += 6;
